...
async function isScenarioForStoryboard(db, storyboardId) {
  try {
    ...
    return !!(row && row.pp === 'scenario' && row.cus === 1);
  } catch (e) {
    return false;
  }
}
  ...
  videoModels: [
    {
      ...
      tier: 50,
      plan: 'Pro / Team Plan',
      tags: ['Featured', 'Latest', 'I2V', 'Audio'],
    ...
    },
    {
      ...
      tier: 50,
      plan: 'Pro / Team Plan',
      tags: ['Featured', 'Realistic', 'Cinematic', 'Audio'],
      durations: [6, 10],
      resolutions: ['768P', '2K'],
      aspectRatios: ['adaptive', '16:9', '9:16', '1:1', '4:3', '3:4', '21:9'],
      hasAudio: true,
    ...
    },
    {
      ...
      tier: 25,
      plan: 'Semua Plan',
      tags: ['Featured', 'Google', 'Omni', 'Audio'],
      durations: [5, 8, 10],
    ...
    {
      id: 'model_bytedance-seedance-2-0-mini',
      name: 'Seedance 2.0 Mini (ByteDance)',
      tier: 50,
      plan: 'Pro / Team Plan',
      tags: ['Featured', 'Fast', 'ByteDance'],
    ...
    {
      id: 'model_runway-aleph-2',
      name: 'Runway Aleph 2 (Runway)',
      tier: 50,
      plan: 'Pro / Team Plan',
      tags: ['Featured', 'Runway', 'Cinematic', 'Audio'],
      durations: [5, 10],
      resolutions: ['720p', '1080p'],
      aspectRatios: ['16:9', '9:16'],
      hasAudio: true,
    ...
    {
      id: 'model_pruna-p-avatar',
      name: 'P-Video Avatar Lipsync (Pruna)',
      tier: 25,
      plan: 'Semua Plan',
      tags: ['Featured', 'Avatar', 'Lipsync'],
      durations: [5, 10, 15],
      resolutions: ['720p', '1080p'],
    ...
    },
    {
      ...
      name: 'Kling V3 I2V Pro (Kling)',
      tier: 50,
      plan: 'Pro / Team Plan',
      tags: ['Featured', 'Motion', 'High Fidelity', 'Audio'],
    ...
    },
    {
      ...
      name: 'Kling V3 Omni Video (Kling)',
      tier: 50,
      plan: 'Pro / Team Plan',
      tags: ['Omni', 'Motion', 'Audio'],
      durations: [5, 10],
      resolutions: ['720p', '1080p'],
      aspectRatios: ['16:9', '9:16', '1:1'],
      hasAudio: true,
    ...
    },
    {
      ...
      tier: 50,
      plan: 'Pro / Team Plan',
      tags: ['Smooth Motion', 'Cinematic', 'Audio'],
      durations: [5, 10],
      resolutions: ['720p', '1080p'],
      aspectRatios: ['16:9', '9:16', '1:1'],
      hasAudio: true,
    ...
    {
      id: 'model_wan-2-5-i2v',
      name: 'Wan 2.5 I2V (Alibaba)',
      tier: 50,
      plan: 'Pro / Team Plan',
      tags: ['Alibaba', 'Animation', 'Audio'],
      durations: [5, 10],
      resolutions: ['720p', '1080p'],
      aspectRatios: ['16:9', '9:16', '1:1'],
      hasAudio: true,
    ...
    {
      id: 'model_ltx-2-5-fast',
      name: 'LTX-2.5 Fast (Lightricks)',
      tier: 50,
      plan: 'Pro / Team Plan',
      tags: ['Fast', 'Lightricks', 'Audio'],
      durations: [6, 8, 10],
      resolutions: ['720p', '1080p'],
      aspectRatios: ['auto', '16:9', '9:16'],
      hasAudio: true,
    ...
    {
      id: 'model_veo3-1',
      name: 'Google Veo 3.1 (Google)',
      tier: 50,
      plan: 'Pro / Team Plan',
      tags: ['Google', 'Cinematic', 'Audio'],
      durations: [4, 6, 8],
      resolutions: ['720p', '1080p'],
      aspectRatios: ['16:9', '9:16'],
      hasAudio: true,
    ...
    },
    {
      ...
      name: 'Pixverse V6 (PixVerse)',
      tier: 50,
      plan: 'Pro / Team Plan',
      tags: ['Dynamic Animation', 'Audio'],
      durations: [5, 8],
      resolutions: ['720p', '1080p'],
      aspectRatios: ['16:9', '9:16', '1:1'],
      hasAudio: true,
...
async function generateVideoScenario(keyRecord, options = {}) {
  ...
  } else if (modelId === 'model_kling-v3-i2v-pro') {
    params.duration = String(duration === -1 ? '5' : duration);
    params.aspectRatio = aspectRatio === 'adaptive' || aspectRatio === 'auto' ? '16:9' : aspectRatio;
    params.generateAudio = generateAudio;
  } else if (modelId === 'model_kling-v3-omni-video') {
    params.duration = duration === -1 ? 5 : Number(duration);
  ...
  } else if (modelId.includes('p-avatar')) {
